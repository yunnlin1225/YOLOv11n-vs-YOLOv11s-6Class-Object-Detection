...
經比較三組參數於實際影片中的目標辨識、誤檢、漏檢、Bounding Box 定位及連續影格偵測穩定性後，最終選擇 **Confidence Threshold = 0.32、Image Size = 1024、IoU Threshold = 0.70** 作為本階段表現較佳的影片推論設定。
...
為避免同時展示 9 組相似的影片結果造成內容過於冗長，本說明檔主要展示最終選定參數 **conf=0.32、iou=0.70、imgsz=1024** 下的 3 部不同測試影片。
