...
隨著研究方向確立，後續模型訓練、參數優化、五折交叉驗證及實際影片測試，主要集中於本專題核心的 **六類別 YOLOv11n 與 YOLOv11s 模型**。
...
最終六類別資料集包含 **Dog、Cat、Bear、Pig、Monkey、Person** 六個類別，每個類別皆包含 **150 張影像**，總計 **900 張影像**。
...
最終以 **6 類別、每類 150 張、共 900 張影像**作為本研究後續五折交叉驗證、模型效能分析及最終部署模型建立的主要資料集。
