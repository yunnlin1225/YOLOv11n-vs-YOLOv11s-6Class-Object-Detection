...
# ============================================================
# YOLOv11n 100% Deployment Retraining
...
def create_data_yaml():
    data = {
        ...
        # 100% Retraining 不保留獨立 Validation
